...
# Now,imply bind this function to a key, by adding this to your ~/.config/ranger/rc.conf: map <C-f> fzf_select
...
class fzf_locate(Command):
    ...
    def execute(self):
        import subprocess
        if self.quantifier:
            command=" locate home MacOSX-Data MacOSX-Data2 MacOSX-Data3 | fzf -e -i"
        else:
            command=" locate home MacOSX-Data MacOSX-Data2 MacOSX-Data3 | fzf -e -i"
