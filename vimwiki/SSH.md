	    ...
	    sequence = 5000,4000,3000
	     seq_timeout = 5
	      command = /sbin/iptables -D INPUT -i eth0 -s %IP% -p tcp –dport 22 -j ACCEPT
	       ...
	       Dumps a MySQL database over a compressed SSH tunnel aand uses it as input to mysql – i think that is the fastest and best way to migrate a DB to a new server!
