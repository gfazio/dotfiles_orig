...
inoremap    <buffer>  <silent>  <LocalLeader>+tr   <Esc>:call C_InsertTemplate("cpp.try-catch")<CR>
 ...
 noremap    <buffer>  <silent>  <LocalLeader>+uns        :call C_InsertTemplate("cpp.namespace-std")<CR>
vnoremap    <buffer>  <silent>  <LocalLeader>+uns   <Esc>:call C_InsertTemplate("cpp.namespace-std", "v")<CR>
