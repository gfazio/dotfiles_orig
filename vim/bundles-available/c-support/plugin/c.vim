...
"
	...
	exe "amenu <silent> ".MenuCpp.'.&using\ namespace\ std;<Tab>\\+uns      :call C_InsertTemplate("cpp.namespace-std")<CR>'
	exe "imenu <silent> ".MenuCpp.'.&using\ namespace\ std;<Tab>\\+uns <Esc>:call C_InsertTemplate("cpp.namespace-std")<CR>'
